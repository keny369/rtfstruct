...
Part of [Sourcetrace](https://lumenandlever.com/sourcetrace) by [Lumen & Lever](https://lumenandlever.com).
Sourcetrace RTF is the public product line; `rtfstruct` is the Apache-2.0 Python library behind it.

Product page: [Sourcetrace](https://lumenandlever.com/sourcetrace) · Source: [GitHub](https://github.com/keny369/rtfstruct)
